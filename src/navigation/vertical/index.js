const navigation = () => {
  return [
    ...
    },
    {
      ...
      path: '/apps/procedure-templates'
    },
    {
      title: 'Procedure Runs',
      icon: 'solar:document-add-outline',
      path: '/apps/procedure-runs'
    },
    {
      title: 'Lists',
    ...
    },
    {
      ...
      path: '/apps/units-of-measurements'
    },
    {
      title: 'Equipment',
      icon: 'tabler:backhoe',
    ...
    },
    {
      ...
      children: [
        ...
        },
        {
          ...
          path: '/apps/approval-group'
        },
        {
          title: 'Approval Routes',
          icon: 'tabler:route',
          path: '/apps/approval-route'
        },
      ]
    },
    {
      sectionTitle: 'Others & Help'
    },
    {
      title: 'Email',
      icon: 'tabler:mail',
